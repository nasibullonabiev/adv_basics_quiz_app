import 'package:adv_basics_quiz_app/question_identifier.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class SymmaryItem extends StatelessWidget {
  const SymmaryItem(this.itemData,{super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        QuestionIdentifier(isCorrectIndex: isCorrectAnswer,
